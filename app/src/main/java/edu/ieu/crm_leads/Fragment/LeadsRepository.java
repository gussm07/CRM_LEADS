package edu.ieu.crm_leads.Fragment;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import edu.ieu.crm_leads.Fragment.Modelo.Lead;
import edu.ieu.crm_leads.R;
...
public class LeadsRepository {
    ...
    private LeadsRepository() {
        ...
        saveLead(new Lead("Linda Murillo", "Directora de Marketing", "Seguros Boliver", R.drawable.lead_photo_3));
        saveLead(new Lead("Lizeth Astrada", "CEO", "Concesionario Motolox", R.drawable.lead_photo_2));
    }
